...
import {
  AwardIcon, BookIcon, CameraIcon, FlameIcon, HeartIcon, LibraryIcon, MusicIcon,
  ReportIcon, RocketIcon, TargetIcon, ZapIcon,
} from "../../icons/index.js";
import { HUES } from "../rotina/wishlist/wishConstants.js";
...
export const MOON_STYLE: Record<string, { label: string; icon: IconType; col: string }> = {
...
export const GOAL_ICONS: { id: string; icon: IconType }[] = [
...
export const GOAL_ICON_MAP: Record<string, IconType> = Object.fromEntries(GOAL_ICONS.map((g) => [g.id, g.icon]));
